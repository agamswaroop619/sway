...
const SideNavBar: React.FC<PropsType> = ({ setSideNav }) => {
  ...
  return (
    <div className="z-10 lg:w-0 md:w-0 xl:w-0 sm:w-[60vw] xs:w-[70vw]  w-[100vw] py-10 px-5 bg-white h-[100vh] flex flex-col text-black">
        ...
        <div>
          <div className="flex gap-4 mt-2" onClick={() => setOpen(!open)}>
            ...
            <GoChevronDown className={`  ${
                open === true ? " transition duration-500 ease rotate-180" : "transition duration-500 ease rotate-0"
              }`} />
          </div>
          ...
          >
             <li>
                <Link className="my-2" href="/shop">Oversized Tshirts</Link>
              </li>

              <li>
                <Link className="my-2" href="/shop/regular">Regular Tshirts</Link>
              </li>

              <li>
                <Link className="my-2" href="/shop/polo">Polo</Link>
              </li>

              <li>
                <Link className="my-2" href="/shop/psychedelics">Psychedelics Tshirts</Link>
              </li>
            </ul>
          ) : null}
        </div>
