...
<div>
  ...
  >
     <li>
      ...
      <li>
        <Link className="my-4" href="/shop/regular">Regular Tshirts</Link>
      </li>

      <li>
        <Link className="my-4" href="/shop/polo">Polo</Link>
      </li>

      <li>
        <Link className="my-4" href="/shop/psychedelics">Psychedelics Tshirts</Link>
      </li>
    </ul>
  ) : null}
</div>
