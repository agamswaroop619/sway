      ...
      <div className="bg-black text-white px-6 mx-12 py-12">
        ...
        <section>
          ...
          <div className="mb-8">
            ...
            <p className="text-lg">
              We believe less is more. Our thoughtfully designed pieces embrace
              minimalism, ensuring that each garment becomes a versatile and
          ...
          <div className="mb-8">
            ...
            <p className="text-lg">
              Embracing the circular economy, we design with longevity in mind.
              Our pieces are intended to be treasured for years, encouraging a
              shift away from disposable fashion. When you invest in our
          ...
          <div className="mb-8">
            ...
            <p className="text-lg">
              ...
              practices. This dedication to craftsmanship ensures exceptional
              quality and supports a network of talented individuals.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-lg">
              ...
              know the story behind each piece you wear. We update all
          ...
          <div className="mb-8">
            ...
            <p className="text-lg">
              Our brand is part of a community that shares a vision for a better
              world. Through collaborations and initiatives, we aim to inspire
              and empower individuals to make conscious choices and contribute
              to positive change.
            </p>
          </div>
